...
<form action="index.php?ctl=reservation&action=ajoutReservation" method="post" class="container mt-4">
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="nom_produit" name="nom_produit" value="<?php echo $data['NomProduit']; ?>">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="tarif" name="tarif" value="<?php echo $data['Tarif']; ?>">
        </div>
    </div>
    ...
    <input type="hidden" name="qte" value="<?php echo $data['Quantite']; ?>">
